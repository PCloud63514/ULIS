		 ...
		 <div id="main">
            ...
            <div class="container_16 clearfix" id="actualbody">
                ...
                <div class="grid_16 widget first">
                	<div class="widget_title clearfix"><h2>학생 조회</h2></div>
                    	  ...
                    	  <div id="table3">
                    	  	<table class="simple">
                    	  		 <tr>
                                    ...
                                    <td>
                                        <c:out value="${studentView.STUDENTNAME}"/>
                                    </td>
                                </tr>
                    	  		 <tr>
                                    <td width="15%" style="padding-left: 10px;">
                                    ...
                                    <td>
                                        <c:out value="${studentView.GRADE}학년"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="15%" style="padding-left: 10px;">
                                    ...
                                    <td>
                                        <c:out value="${studentView.SUBJECTNAME}"/>
                                    </td>
                                </tr>
                    	  		 <tr>
                                    <td width="15%" style="padding-left: 10px;">
                                    ...
                                    <td>
                                        <c:out value="${studentView.STUDENTNO}"/>
                                    </td>
                                </tr>
                    	  	</table>
                    	  	<div class="clear"></div>
                    ...
                    <div style="text-align: right; padding-top: 10px;">
					        ...
					        <a href="<c:url value="/student/update/${studentView.STUDENTNO}" />">
					            <input type="button" id="button_add" 
					                name="button_add" value="수정" />
					        </a>
					</div>
                </div>
                <div class="clear"></div>
